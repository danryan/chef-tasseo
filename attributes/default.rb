...
default[:tasseo][:graphite_web_protocol]  = "https"
default[:tasseo][:graphite_server]  = "localhost"
default[:tasseo][:graphite_role] = "graphite_server"
default[:tasseo][:graphite_auth] = "username:changeme"
default[:tasseo][:url]           = "tasseo.example.com"
default[:tasseo][:nginx][:port]  = 80
